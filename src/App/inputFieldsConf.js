const inputFieldsConf = [
    {
        ...
        CP0:{
            ...
            disabled:true,
            toM:(x)=>(x),
            fromM:(m)=>{let value=(((1+(m*m)/5)**(3.5)-1)/(0.7*m*m));
    ...
    },
    {
        ...
        prantdlAngle:{
            ...
            disabled:true,
            toM:(x)=>(x),
           fromM:(m)=>{let value=(Math.sqrt(6)*Math.atan(Math.sqrt((1/6)*(m**2-1)))-Math.atan(Math.sqrt(m**2-1)))*(180/Math.PI)
                            return value ===0 ?"0":value},
            width:150
        }
    },
    {
      ...
      p0HeadToP0:{
        ...
        toM:(m)=>(m),
          disabled:true,
        fromM:(m)=>(((5.76*m**2)/(5.6*m**2-0.8))**(3.5)*((-0.4+2.8*m**2)/2.4)*((1+m**2/5)**(-3.5))),
        width:150
      },
      mHead:{
        id: "mHead",
